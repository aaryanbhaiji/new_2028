...
photologo = 'https://graph.org/file/5ed50675df0faf833efef-e102210eb72c1d5a17.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://graph.org/file/5ed50675df0faf833efef-e102210eb72c1d5a17.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://graph.org/file/5ed50675df0faf833efef-e102210eb72c1d5a17.jpg'
photozip = 'https://graph.org/file/5ed50675df0faf833efef-e102210eb72c1d5a17.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/heroku_cc_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/heroku_cc_bot"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/heroku_cc_bot")],
    ]
)
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://graph.org/file/5ed50675df0faf833efef-e102210eb72c1d5a17.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/heroku_cc_bot")],
        ])
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/5ed50675df0faf833efef-e102210eb72c1d5a17.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
